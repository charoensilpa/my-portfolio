/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ff37ce8a4f5f99cfcefef53d776aabbc)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SANITY_TOKEN">> {}
}
